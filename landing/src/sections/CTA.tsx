...
// Seção de chamada para ação com gradiente roxo e botão teal
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #7B5EA7 0%, #5A3E7A 60%, #3D2855 100%)',
        }}
      />
      ...
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(91,191,184,0.20) 0%, transparent 70%)' }}
        aria-hidden="true"
      />
